...
/// <br/>
/// <see langword="public"/> <see cref="T:DanmakuPlayer.Attributes.DependencyPropertyAttribute`1"/> Field { <see langword="get"/> => (<see cref="T:DanmakuPlayer.Attributes.DependencyPropertyAttribute`1"/>)GetValue(Property); <see langword="set"/> => SetValue(Property, <see langword="value"/>); }
///     </code>
/// </summary>
